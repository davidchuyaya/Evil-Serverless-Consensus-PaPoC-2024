...
Recent work suggests that localized, rule-driven rewrites can be mechanically applied to \jmh{correctly} scale existing (non-BFT) protocols, including Paxos.
